...
?>
    ...
    <!--advertise  -->
    <section class="section-padding advertising" ">
    ...
    <!-- /tutorial -->
    <section class=" section-padding" style=" background-color:#e5f6ea">
        <div class="tutorial-container">
            <div class="index-tutorial-details">
                <div>
                    <h2 style=" font-family: Times New Roman">Hướng Dẫn Đặt Xe</h2>
                </div>
                <div class="icons-container">
                    <div>
                        <div><img src="assets\images\untitled14.png" alt="first step"></div>
                        <p>Đặt xe với carrental</p>
                    </div>
                    <div>
                        <div><img src="assets\images\untitled13.png" alt="first step"></div>
                        <p>Nhận xe hoặc giao tận nơi</p>
                    </div>
                    <div>
                        <div><img src="assets\images\untitled12.png" alt="first step"></div>
                        <p>Trải nghiệm chuyến đi</p>
                    </div>
                    <div>
                        <div><img src="assets\images\untitled11.png" alt="first step"></div>
                        <p>Kết thúc giao dịch</p>
                    </div>
                </div>
                <div style="font-size: 18px;;align-self: flex-end;padding-right:5%">
                    <a href="tutorial.php">Chi Tiết ...</a>
                </div>
            </div>
        </div>
    </section>
